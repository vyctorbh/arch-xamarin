...
{
    public class IntercarnesViewModel : BaseViewModel
    {
		...
		public IntercarnesViewModel(IAppLoader appLoader, MainModel mainModel, IDefaultMessenger defaultMessenger) : base(defaultMessenger)
		{
					...
					?? (_loadmoreCommand = new RelayCommand(
						async () =>
						{
							...
							using (var releaser = await _lock.LockAsync())
							{
								...
								await MainModel.List("Intercarnes", null, null, this.numberpage, this.skippage, this.Message);
